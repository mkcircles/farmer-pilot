                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-p20b" align="center" style="font-size:0">
                                                                <a href="https://de.innovationvillage.co.ug/" target="_blank">
                                                                    <img src="https://de.innovationvillage.co.ug/wp-content/uploads/2022/09/Innovation-Village-New-Logo.png" alt="Innovation Village" style="display: block;" width="154">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    ...
                                                    <table style="border-radius: 3px; border-collapse: separate; background-color: #fcfcfc;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fcfcfc">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p20r es-p20l" bgcolor="#fcfcfc" align="left">
                                                                <p>Hi {{$user->name}}, your account on the Digital Economy Rails platform with the details below.<br></p>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <span class="es-button-border" style="margin-top:50px; background: #f8f3ef none repeat scroll 0% 0%;">
                                                                    <a href="https://rails.innovationvillage.co.ug/" class="" target="_blank" style="background: #f8f3ef none repeat scroll 0% 0%; mso-border-alt: 10px solid  #f8f3ef">Log In Now</a>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        </tbody>
