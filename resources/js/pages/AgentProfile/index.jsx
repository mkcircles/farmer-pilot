...
const FarmersListByStatus = lazy(() => import("./FarmersListByStatus"));
const FarmersList = lazy(() => import("../FarmersList"));
...
function Main() {
    ...
    const UpdateAgentStatus = (status) => {
        return new Promise((resolve, reject) => {
            ...
            axios
                .put(
                    `${BASE_API_URL}/agent/status/update`,
                    {
                        agent_id: agent?.id,
                        status: status,
                    },
    ...
    return (
        <>
            ...
            <div
                ref={scrollToTop}
                className="flex flex-col items-center mt-8 intro-y sm:flex-row"
            >
            ...
            <div className="grid grid-cols-12 gap-5 mt-5 relative">
                ...
                <div
                    className={`flex flex-col absolute transition-all duration-700 sm:end-0 end-auto w-48 mr-1 ${
                        showManageAccountMenu
                            ? "-top-4 z-50 h-fit box"
            ...
            <div className="w-full h-full mt-4">
                <Card>
                    <TabGroup>
                        <TabList className="">
                            <Tab icon={Users}>All Farmers Profiled</Tab>
                            <Tab icon={AlertTriangle}>
                                Invalid Farmer Profiles
                            </Tab>
                            <Tab icon={UserCheck2}>Valid Farmer Profiles</Tab>
                        </TabList>
                        <TabPanels>
                            <TabPanel>
                            ...
                            <TabPanel>
                                <Suspense fallback={<Loading />}>
                                    <FarmersListByStatus
                                        status={"invalid"}
                                        subTitle={
                                            "Overview of Invalid Farmer Profiles"
                                        }
                                        agent_id={agent?.id}
                                    />
                                </Suspense>
                            ...
                            <TabPanel>
                                <Suspense fallback={<Loading />}>
                                    <FarmersListByStatus
                                        status={"valid"}
                                        subTitle={
                                            "Overview of Valid Farmer Profiles"
                                        }
                                        agent_id={agent?.id}
                                    />
                                </Suspense>
