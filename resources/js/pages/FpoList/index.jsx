...
import { CREATE_FPO, EDIT_FPO, FARMER_PROFILE, FPO_PROFILE } from "../../router/routes";
                    ...
                    <TableBody >
                        {fpoData?.data?.map((fpo) => (
                            <TableRow key={fpo.id}>
                                ...
                                <TableCell>{numberFormatter(parseInt(fpo.fpo_membership_number))}</TableCell>
                                <TableCell>
                                    <span class="inline-flex overflow-hidden rounded-md border bg-white shadow-sm">
                                        <button
                                        onClick={() => navigate(`${FPO_PROFILE}/${fpo.id}`)}
                                            className="inline-block border-e px-3 py-2 text-gray-700 hover:bg-gray-50 focus:relative"
